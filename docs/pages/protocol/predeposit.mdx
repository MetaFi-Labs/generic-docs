...
If a Status predeposit is in the withdrawn state, follow the [Status predeposit withdrawal guide](/guides/withdrawals/status-predeposit) to reclaim it through Etherscan.
