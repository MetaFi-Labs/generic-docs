...
:::tip
For a simplified deposit experience, use the [Generic Depositor](/periphery/depositor) from the periphery contracts. It automatically handles vault resolution, approvals, and provides convenient functions for depositing, bridging, or predepositing in a single transaction.
:::
