...
:::danger
**Generic Money has wound down.**

This site remains available as a technical archive and to help users recover funds without the Generic app. Do not deposit or bridge new funds into the protocol.

Choose the guide that matches where your funds are held:

- [Ethereum Mainnet: redeem GUSD or GenericUnit](/guides/withdrawals/ethereum)
- [Status predeposit vault: withdraw an eligible predeposit](/guides/withdrawals/status-predeposit)
- [Citrea: redeem your tokens and bridge them to Ethereum](/guides/withdrawals/citrea)

If you are unsure which route applies, [start with the withdrawal route guide](/guides/withdrawals/overview).
:::
